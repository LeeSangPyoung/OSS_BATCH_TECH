...
%><%!
	 ...
	 */
	String printJobFilter(String filter, jakarta.servlet.http.HttpServletRequest request) {
     ...
     */
     Map<String, String> getJobFilterCodeList(jakarta.servlet.http.HttpServletRequest request) {
...
//  String localDatetimePatternSplit = "MM/dd/yyyy'<br'>HH:mm:ss";
    ...
    boolean isRequirePasswordForJobAction(jakarta.servlet.http.HttpServletRequest request) {
    	return false;
    }

	boolean useEndFailAlert(jakarta.servlet.http.HttpServletRequest request) {
		return true;
	}
