...
<% /* ================== User 관련 함수 ======================*/ %>
    ...
    function openEditFormUser(userid) {
        ...
        window.open("form_setting_user?userid="+userid, "user_"+userid, 'width=820,height=600,left='+left+',top='+top+',scrollbars=1').focus();
    }
    
    function openAddNewFormUser() {
    	var left = (window.screen.width  / 2) - ((600 / 2) + 10);
        var top  = (window.screen.height / 2) - ((600 / 2) + 50);
    	window.open("form_setting_user", "user_new", 'width=820,height=600,left='+left+',top='+top+',scrollbars=1').focus();
    }
...
<form name="form0" action="view_setting" method="GET">
...
<form name="form1" action="action_user" method="POST">
<input type="hidden" name="suburl" value="user">
