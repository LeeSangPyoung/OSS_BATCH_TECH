...
<%@ page import="org.apache.ibatis.session.ResultHandler, org.apache.ibatis.session.ResultContext" %>
...
%><%
	...
	ResultHandler<Map<String, Object>> resultHandler = new ResultHandler<Map<String, Object>>() {
	    ...
	    public void handleResult(ResultContext<? extends Map<String, Object>> context) {
	        ...
	        long[] progress = admin.getJobProgress(jobins.getLastJobExeId());
	        runStats.sumToThis(jobins, getJobFilterCode(jobins.getJobId()), 
	            progress == null ? 0 : progress[0], progress == null ? 0 : progress[1]);
	...
	admin.getJobInstanceListFreeColumnWithRowHandler(queryParamMap, resultHandler); 
