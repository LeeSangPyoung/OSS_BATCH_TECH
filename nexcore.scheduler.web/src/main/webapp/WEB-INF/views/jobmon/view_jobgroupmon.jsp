...
<script>
	...
	function gotoTileStyle() {
		document.form1.action="view_jobgroupmon_tile";
		doQuery();
	}

	function doExcelDownload() {
        document.form1.action="view_jobgroupmon_excel";
        document.form1.target='';
        document.form1.submit();
        document.form1.action="view_jobgroupmon";
    }
...
<form name="form1" action="view_jobgroupmon" method="get" style="margin-top:0;margin-bottom:0">
