...
<% /* ============ JobGroup 속성 정의 관련 함수 ===================*/ %>
	...
	function openEditFormJobGroup(jobgroupid) {
	    window.open("form_setting_jobgroup?jobgroupid="+jobgroupid, "jobgroup_"+jobgroupid.replace(/-/g, ''), 'width=600,height=500,scrollbars=1').focus();
	}
	
	function openAddNewFormJobGroup(parentid) {
	    window.open("form_setting_jobgroup?parentid="+parentid, "jobgroup_new", 'width=810,height=500,scrollbars=1').focus();
	}

	function doExcelDownload() {
        document.form1.action="view_setting_jobgroup_excel";
        document.form1.target='';
        document.form1.submit();
        document.form1.action="action_setting";
	}

    function openExcelUploadForm() {
        window.open("form_setting_jobgroup_upload", 'upload', 'width=810,height=400,scrollbars=1').focus();
    }
    ...
    function orderby(orderbyCol) {
        ...
        window.location.href = 'view_setting?suburl=jobgroup&orderby='+orderbyCol+'&orderdir='+orderdir;
    }
...
<form name="form1" action="action_setting" method="POST"  style="margin-top:0;margin-bottom:0">
