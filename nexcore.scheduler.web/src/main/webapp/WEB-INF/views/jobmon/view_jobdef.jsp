...
<script>
    ...
    function doQuery() {
        document.form1.action="view_jobdef";
    ...
    function openJobDefinitionFormWin(jobid, mode) {
        window.open("form_jobdef?jobid="+jobid+"&mode="+mode, '', 'width=820,height=800,scrollbars=1').focus();
    }
    ...
    function openJobGroupSelectWin(targetElemName) {
        window.open("popup_jobgroup?target_name="+targetElemName, 'jobgroupselect', 'width=700,height=400,scrollbars=1').focus();
    }
