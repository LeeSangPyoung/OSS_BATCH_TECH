...
<%--					<button class="Button Onlyicon btn-lng" onclick="javascript:logout();"><span class="Icon icon-lng"></span><%=Label.get("top.logout")%></button> --%>
				...
				<div class="leftmenu-wrap">
					<ul class="leftmenu">
						<li>
							<a href="view_jobdef"><span class="Icon left-icon1"></span><%=Label.get("top.menu.jobdef")%></a>
						</li>
						<li>
							<a href="view_jobins"><span class="Icon left-icon2"></span><%=Label.get("top.menu.jobins")%></a>
						</li>
						<li>
							<a href="view_jobgroupmon"><span class="Icon left-icon3"></span><%=Label.get("top.menu.jobgroupmon")%></a>
						</li>
						<li>
							<a href="view_jobdefstg"><span class="Icon left-icon4"></span><%=Label.get("top.menu.jobdefstg")%></a>
						</li>
						<li>
							<a href="view_server"><span class="Icon left-icon5"></span><%=Label.get("top.menu.server")%></a>
						</li>
						<li>
