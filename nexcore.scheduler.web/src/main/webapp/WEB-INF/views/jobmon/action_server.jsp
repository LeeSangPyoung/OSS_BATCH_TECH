...
<%!
	AgentInfo getAgentInfo(jakarta.servlet.http.HttpServletRequest request) {
...
%><%
	...
	String  returnUrl    = "view_server";  /* closeThisWin=false 일 경우는 sendRedirect 할 URL을 지정해주어야한다. */
	...
	try {
		...
		if ("add_agent".equals(cmd)) {
		    ...
		    returnUrl = "form_server?doreload=yes"; /* 신규인 경우는 form 창 유지하고 parent 만 reload 함 */
