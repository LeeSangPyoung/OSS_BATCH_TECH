...
public class JobDefinitionManager {
	 ...
	 * return (JobDefinition)sqlMapClient.queryForObject(
	 * "nbs.scheduler.selectJobDefinitionByJobId", jobId); }
	 */
	public JobDefinition getJobDefinition(String jobId) throws SQLException {
	    return sqlSession.selectOne("nbs.scheduler.selectJobDefinitionByJobId", jobId);
	}
	 ...
	 * List<Map> preJobCondList = sqlMapClient.queryForList(
	 * "nbs.scheduler.selectJobDefPreJobConditionsByJobId", jobdef.getJobId());
	 * 
	...
	public void loadPreJobConditions(JobDefinition jobdef) throws SQLException {
	    List<Map<String, String>> preJobCondList = sqlSession.selectList("nbs.scheduler.selectJobDefPreJobConditionsByJobId", jobdef.getJobId());
	 ...
	 * List<Map> postJobTriggerList =
	 * sqlMapClient.queryForList("nbs.scheduler.selectJobDefPostJobTriggersByJobId",
	 * jobdef.getJobId());
	 * 
	 * List<PostJobTrigger> list = new ArrayList(); for (Map<String, String>
	 * postJobTrigger : postJobTriggerList) { list.add(new
	...
	public void loadPostJobTriggers(JobDefinition jobdef) throws SQLException {
	    List<Map<String, String>> postJobTriggerList = sqlSession.selectList("nbs.scheduler.selectJobDefPostJobTriggersByJobId", jobdef.getJobId());
	 ...
	 * List<Map> parameters =
	 * sqlMapClient.queryForList("nbs.scheduler.selectJobDefParamsByJobId",
	 * jobdef.getJobId());
	 * 
	 * Map inParam = new LinkedHashMap<String, String>(); for (Map param :
	 * parameters) { inParam.put(param.get("PARAM_NAME"), param.get("PARAM_VALUE"));
	 * } jobdef.setInParameters(inParam); }
	 */
	public void loadParameters(JobDefinition jobdef) throws SQLException {
	    List<Map<String, String>> parameters = sqlSession.selectList("nbs.scheduler.selectJobDefParamsByJobId", jobdef.getJobId());
	 ...
	 */
	/*
	 * public List<JobDefinition> getJobDefinitionsByQuery(String query) throws
	 * SQLException { List<JobDefinition> jobdef =
	 * (List<JobDefinition>)sqlMapClient.queryForList(
	 * "nbs.scheduler.selectJobDefinitionsByQuery", query); return jobdef; }
	 */
	public List<JobDefinition> getJobDefinitionsByQuery(String query) throws SQLException {
	    return sqlSession.selectList("nbs.scheduler.selectJobDefinitionsByQuery", query);
	}
	 ...
	 */
	/*
	 * public List<JobDefinition> getJobDefinitionsByDynamicQuery(Map queryParamMap)
	 * throws SQLException { List<JobDefinition> list =
	 * (List<JobDefinition>)sqlMapClient.queryForList(
	 * "nbs.scheduler.selectJobDefinitionsByDynamicQuery", queryParamMap); return
	 * list; }
	 */
	public List<JobDefinition> getJobDefinitionsByDynamicQuery(Map<String, Object> queryParamMap) throws SQLException {
	    return sqlSession.selectList("nbs.scheduler.selectJobDefinitionsByDynamicQuery", queryParamMap);
	}
	 ...
	 */
	/*
	 * public int getJobDefinitionsCount() throws SQLException { return
	 * (Integer)sqlMapClient.queryForObject(
	 * "nbs.scheduler.selectJobDefinitionsCount"); }
	 */

	public int getJobDefinitionsCount() throws SQLException {
	    return sqlSession.selectOne("nbs.scheduler.selectJobDefinitionsCount");
	}
	/**
...
//	public List<JobDefinition> assembleJobDefinition(List<JobDefinition> jobdefList, List<Map> preJobsList, List<Map> triggersList, List<Map> paramsList) {
...
//	}
	public List<JobDefinition> assembleJobDefinition(
		    ...
		    // JobDefinition map 구성
		    Map<String, JobDefinition> jobDefMap = new LinkedHashMap<>();
		    for (JobDefinition jobdef : jobdefList) {
		        jobDefMap.put(jobdef.getJobId(), jobdef);
		    }

		    // Prejob 구성
		    for (Map<String, Object> preJob : preJobsList) {
		        JobDefinition jobdef = jobDefMap.get((String) preJob.get("JOB_ID"));
		        if (jobdef != null) {
		            jobdef.getPreJobConditions().add(new PreJobCondition((Map<String, String>) (Map<?, ?>) preJob));
		        }
		    }

		    // Trigger 구성
		    for (Map<String, Object> trigger : triggersList) {
		        JobDefinition jobdef = jobDefMap.get((String) trigger.get("JOB_ID"));
		        if (jobdef != null) {
		            jobdef.getTriggerList().add(new PostJobTrigger((Map<String, String>) (Map<?, ?>) trigger));
		        }
		    }

		    // 파라미터 구성
		    for (Map<String, Object> param : paramsList) {
		        JobDefinition jobdef = jobDefMap.get((String) param.get("JOB_ID"));
		        if (jobdef != null) {
		            jobdef.getInParameters().put(
		                (String) param.get("PARAM_NAME"), 
	 ...
	 */
	/*
	 * public List<JobDefinition> getJobDefinitionsDeepByQuery(String query) throws
	 * SQLException { List<JobDefinition> jobdefList =
	 * (List<JobDefinition>)sqlMapClient.queryForList(
	 * "nbs.scheduler.selectJobDefinitionsByQuery", query); List<Map> preJobsList =
	 * (List<Map>)sqlMapClient.queryForList(
	 * "nbs.scheduler.selectJobDefPreJobConditionsByQuery", query); List<Map>
	 * triggersList= (List<Map>)sqlMapClient.queryForList(
	 * "nbs.scheduler.selectJobDefPostJobTriggersByQuery", query); List<Map>
	 * paramsList = (List<Map>)sqlMapClient.queryForList(
	 * "nbs.scheduler.selectJobDefParamsByQuery", query);
	 * 
	 * return assembleJobDefinition(jobdefList, preJobsList, triggersList,
	 * paramsList); }
	 */
	public List<JobDefinition> getJobDefinitionsDeepByQuery(String query) throws SQLException {
	    List<JobDefinition> jobdefList = sqlSession.selectList("nbs.scheduler.selectJobDefinitionsByQuery", query);
	    List<Map<String, Object>> preJobsList = sqlSession.selectList("nbs.scheduler.selectJobDefPreJobConditionsByQuery", query);
	    List<Map<String, Object>> triggersList = sqlSession.selectList("nbs.scheduler.selectJobDefPostJobTriggersByQuery", query);
	    List<Map<String, Object>> paramsList = sqlSession.selectList("nbs.scheduler.selectJobDefParamsByQuery", query);
	 ...
	 */
	/*
	 * public List<JobDefinition> getJobDefinitionsDeepByDynamicQuery(Map
	 * queryParamMap) throws SQLException { List<JobDefinition> jobdefList =
	 * (List<JobDefinition>)sqlMapClient.queryForList(
	 * "nbs.scheduler.selectJobDefinitionsByDynamicQuery", queryParamMap); List<Map>
	 * preJobsList = (List<Map>)sqlMapClient.queryForList(
	 * "nbs.scheduler.selectJobDefPreJobConditionsByDynamicQuery", queryParamMap);
	 * List<Map> triggersList= (List<Map>)sqlMapClient.queryForList(
	 * "nbs.scheduler.selectJobDefPostJobTriggersByDynamicQuery", queryParamMap);
	 * List<Map> paramsList = (List<Map>)sqlMapClient.queryForList(
	 * "nbs.scheduler.selectJobDefParamsByDynamicQuery", queryParamMap);
	 * 
	 * return assembleJobDefinition(jobdefList, preJobsList, triggersList,
	 * paramsList); }
	 */
	public List<JobDefinition> getJobDefinitionsDeepByDynamicQuery(Map<String, Object> queryParamMap) throws SQLException {
	    List<JobDefinition> jobdefList = sqlSession.selectList("nbs.scheduler.selectJobDefinitionsByDynamicQuery", queryParamMap);
	    List<Map<String, Object>> preJobsList = sqlSession.selectList("nbs.scheduler.selectJobDefPreJobConditionsByDynamicQuery", queryParamMap);
	    List<Map<String, Object>> triggersList = sqlSession.selectList("nbs.scheduler.selectJobDefPostJobTriggersByDynamicQuery", queryParamMap);
	    List<Map<String, Object>> paramsList = sqlSession.selectList("nbs.scheduler.selectJobDefParamsByDynamicQuery", queryParamMap);
...
//	}
	public List<JobDefinition> getJobDefinitionsByJobIdList(List<String> jobIdList) throws SQLException {
        if (jobIdList == null || jobIdList.isEmpty()) {
            ...
            in.put("jobIdList", jobIdList);
            return sqlSession.selectList("nbs.scheduler.selectJobDefinitionsByJobIdList", in);
        }
    }
	...
	/*
	 * public List<JobDefinition> getJobDefinitionsDeepByJobIdList(List<String>
	 * jobIdList) throws SQLException { if (jobIdList == null || jobIdList.size() ==
	 * 0) { return new ArrayList<JobDefinition>(); }else { Map in = new HashMap();
	 * in.put("jobIdList", jobIdList); List<JobDefinition> jobdefList =
	 * (List<JobDefinition>)sqlMapClient.queryForList(
	 * "nbs.scheduler.selectJobDefinitionsByJobIdList", in); List<Map> preJobsList =
	 * (List<Map>)sqlMapClient.queryForList(
	 * "nbs.scheduler.selectJobDefPreJobConditionsByJobIdList", in); List<Map>
	 * triggersList = (List<Map>)sqlMapClient.queryForList(
	 * "nbs.scheduler.selectJobDefPostJobTriggersByJobIdList", in); List<Map>
	 * paramsList = (List<Map>)sqlMapClient.queryForList(
	 * "nbs.scheduler.selectJobDefParamsByJobIdList", in);
	 * 
	 * return assembleJobDefinition(jobdefList, preJobsList, triggersList,
	 * paramsList); } }
	 */
	...
	public List<JobDefinition> getJobDefinitionsDeepByJobIdList(List<String> jobIdList) throws SQLException {
	    if (jobIdList == null || jobIdList.isEmpty()) {
	        ...
	        List<JobDefinition> jobdefList = sqlSession.selectList("nbs.scheduler.selectJobDefinitionsByJobIdList", in);
	        List<Map<String, Object>> preJobsList = sqlSession.selectList("nbs.scheduler.selectJobDefPreJobConditionsByJobIdList", in);
	        List<Map<String, Object>> triggersList = sqlSession.selectList("nbs.scheduler.selectJobDefPostJobTriggersByJobIdList", in);
	        List<Map<String, Object>> paramsList = sqlSession.selectList("nbs.scheduler.selectJobDefParamsByJobIdList", in);
	 ...
	 */
	/*
	 * public List<Map> getJobDefinitionsFreeColumnByDynamicQuery(Map queryParamMap)
	 * throws SQLException { return sqlMapClient.queryForList(
	 * "nbs.scheduler.selectJobDefinitionsFreeColumnByDynamicQuery", queryParamMap);
	 * }
	 */
	public List<Map<String, Object>> getJobDefinitionsFreeColumnByDynamicQuery(Map<String, Object> queryParamMap) throws SQLException {
	    return sqlSession.selectList("nbs.scheduler.selectJobDefinitionsFreeColumnByDynamicQuery", queryParamMap);
	}
...
//	}
	...
	public int insertJobDefinition(JobDefinition jobdef) throws SQLException {
	    // NBS_JOB_DEF 테이블 insert 
	    jobdef.setLastModifyTime(DateUtil.getCurrentTimestampString());
	    int cnt = sqlSession.insert("nbs.scheduler.insertJobDefinition", jobdef);
...
//	
	public void insertPreJobCondition(JobDefinition jobdef) throws SQLException {
	    ...
	    for (PreJobCondition cond : jobdef.getPreJobConditions()) {
	        ...
	        map.put("okFail", cond.getOkFail());
	        map.put("andOr", cond.getAndOr());
	        sqlSession.insert("nbs.scheduler.insertJobDefPreJobList", map);
	    }
	}
...
//	}
	public void insertPostJobTriggers(JobDefinition jobdef) throws SQLException {
	    ...
	    for (PostJobTrigger trigger : jobdef.getTriggerList()) {
	        ...
	        map.put("triggerJobId", trigger.getTriggerJobId());
	        map.put("instanceCount", trigger.getJobInstanceCount());
	        sqlSession.insert("nbs.scheduler.insertJobDefPostJobTrigger", map);
	    }
	}
...
//	}
	...
	public void insertParameter(JobDefinition jobdef) throws SQLException {
	    ...
	    for (Map.Entry<String, String> param : jobdef.getInParameters().entrySet()) {
	        ...
	        map.put("paramName", param.getKey());
	        map.put("paramValue", param.getValue());
	        sqlSession.insert("nbs.scheduler.insertJobDefParam", map);
	    }
	}
...
//	}
	public int updateJobDefinition(JobDefinition jobdef) throws SQLException {
	    ...
	    jobdef.setLastModifyTime(DateUtil.getCurrentTimestampString());
	    int updateCnt = sqlSession.update("nbs.scheduler.updateJobDefinition", jobdef);
...
//	}
	public int updateJobDefinitionLogLevel(String jobId, String logLevel) throws SQLException {
	    ...
	    param.put("logLevel", logLevel == null ? null : logLevel.toUpperCase());
	    param.put("jobId", jobId);
	    return sqlSession.update("nbs.scheduler.updateJobDefinitionLogLevel", param);
	}
...
//	}
	...
	public int deleteJobDefinition(String jobDefId) throws SQLException {
	    // NBS_JOB_DEF 테이블 delete
	    int cnt = sqlSession.delete("nbs.scheduler.deleteJobDefinition", jobDefId);
	    if (cnt > 0) {
	        deletePreJobCondition(jobDefId);
	        deletePostJobTriggers(jobDefId);
	        deleteParameter(jobDefId);
...
//	}
	public int deletePreJobCondition(String jobDefId) throws SQLException {
	    return sqlSession.delete("nbs.scheduler.deleteJobDefPreJobList", jobDefId);
	}
...
//	}
	public int deletePostJobTriggers(String jobDefId) throws SQLException {
	    return sqlSession.delete("nbs.scheduler.deleteJobDefPostJobTrigger", jobDefId);
	}
...
//	}
	public int deleteParameter(String jobDefId) throws SQLException {
	    return sqlSession.delete("nbs.scheduler.deleteJobDefParam", jobDefId);
	}
...
//	}
	public String getJobGroupId(String jobDefId) throws SQLException {
	    return sqlSession.selectOne("nbs.scheduler.getJobDefinitionGroupId", jobDefId);
	}
