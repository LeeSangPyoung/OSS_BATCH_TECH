...
//	}
	private int insertJobNotify(JobNotify jobNotify) throws SQLException {
	    return sqlSession.insert("nbs.monitor.insertJobNotify", jobNotify);
	}

	private JobNotify selectJobNotify(int id) throws SQLException {
	    return sqlSession.selectOne("nbs.monitor.selectJobNotify", id);
	}
	...
	private List<JobNotify> selectJobNotifyByQuery(String query, String orderBy) throws SQLException {
	    ...
	    m.put("queryCondition", query);
	    m.put("orderBy", orderBy);
	    return sqlSession.selectList("nbs.monitor.selectJobNotifyByQuery", m);
	}

	private int updateJobNotify(JobNotify jobNotify) throws SQLException {
	    return sqlSession.update("nbs.monitor.updateJobNotify", jobNotify);
	}

	private int deleteJobNotify(int id) throws SQLException {
	    return sqlSession.delete("nbs.monitor.deleteJobNotify", id);
	}
...
//	}
	...
	private int insertJobNotifyReceiver(JobNotifyReceiver jobNotifyReceiver) throws SQLException {
	    return sqlSession.insert("nbs.monitor.insertJobNotifyReceiver", jobNotifyReceiver);
	}

	private JobNotifyReceiver selectJobNotifyReceiver(int id) throws SQLException {
	    return sqlSession.selectOne("nbs.monitor.selectJobNotifyReceiver", id);
	}

	private List<JobNotifyReceiver> selectJobNotifyReceiverByIdList(List<Integer> receiverIdList) throws SQLException {
	    Map<String, Object> param = new HashMap<>();
	    param.put("idList", receiverIdList);
	    param.put("orderBy", "ORDER BY RECEIVER_NAME");

	    return sqlSession.selectList("nbs.monitor.selectJobNotifyReceiverByIdList", param);
	}
	...
	private List<JobNotifyReceiver> selectJobNotifyReceiverByQuery(String query, String orderBy) throws SQLException {
	    ...
	    return sqlSession.selectList("nbs.monitor.selectJobNotifyReceiverByQuery", m);
	}

	private int updateJobNotifyReceiver(JobNotifyReceiver jobNotifyReceiver) throws SQLException {
	    return sqlSession.update("nbs.monitor.updateJobNotifyReceiver", jobNotifyReceiver);
	}

	private int deleteJobNotifyReceiver(int id) throws SQLException {
	    return sqlSession.delete("nbs.monitor.deleteJobNotifyReceiver", id);
	}

	public List<JobNotifySendInfo> selectJobNotifySendList(Map<String, Object> queryParamMap) throws SQLException {
	    return sqlSession.selectList("nbs.monitor.selectJobNotifySendListByDynamicQuery", queryParamMap);
	}

	public int getJobNotifySendListCount(Map<String, Object> queryParamMap) throws SQLException {
	    return sqlSession.selectOne("nbs.monitor.getJobNotifySendListCount", queryParamMap);
	}
				...
				if (mat.matches()) {
					...
					if ("LONGRUN".equals(notify.getWhen())){
						...
						if(executionTime > thresTime){
							...
							List<Map<String, String>> sendInfoList = sqlSession.selectList("nbs.monitor.selectJobNotifySendListForCount", jobexe.getJobId());
		...
		if (notifyProcessors != null) {
			...
			for(String jobexeId : jobexeIdSet){
				...
				if(!receiverMap.isEmpty()){
					...
					List<Map<String, String>> sendInfoList = sqlSession.selectList("nbs.monitor.selectJobNotifySendListForCount", jobexeId);
