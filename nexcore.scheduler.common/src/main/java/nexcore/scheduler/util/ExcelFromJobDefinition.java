...
public class ExcelFromJobDefinition {
	...
	private void initCellStyle(HSSFWorkbook workbook) {
        ...
        titleStyle.setAlignment(HorizontalAlignment.CENTER); // ✅ 정상 동작
        titleStyle.setVerticalAlignment(VerticalAlignment.CENTER); // ✅ 정상 동작
        ...
        font1.setBold(true); // ✅ 정상 동작 (굵게 설정)
        ...
        headerStyle.setAlignment(HorizontalAlignment.CENTER); // ✅ 정상 동작
        headerStyle.setVerticalAlignment(VerticalAlignment.CENTER); // ✅ 정상 동작
		 ...
		 */
        bodyStyle.setAlignment(HorizontalAlignment.CENTER); // ✅ 정상 동작
        bodyStyle.setVerticalAlignment(VerticalAlignment.CENTER); // ✅ 정상 동작
		 ...
		 */
        bodyStyleLeftAlign.setAlignment(HorizontalAlignment.LEFT);
        bodyStyleLeftAlign.setVerticalAlignment(VerticalAlignment.CENTER);
		 ...
		 */
        bodyStyleLeftAlign.setBorderTop(BorderStyle.THIN);
        bodyStyleLeftAlign.setBorderBottom(BorderStyle.THIN);
        bodyStyleLeftAlign.setBorderLeft(BorderStyle.THIN);
        bodyStyleLeftAlign.setBorderRight(BorderStyle.THIN);
    }
